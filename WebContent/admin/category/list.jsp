			...
			<tr>
				<td class="ta_01" align="center" bgColor="#f5fafe">
					<table cellspacing="0" cellpadding="1" rules="all"
						...
						<c:forEach items="${findAllCategory }" var="p" varStatus="status">
							<tr onmouseover="this.style.backgroundColor = 'white'"
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="${pageContext.request.contextPath}/AdminCategoryServlet?method=editCategoryUI&cid=${p.cid }">
										<img
								...
								<td align="center" style="HEIGHT: 22px"><a
									href="javascript:;" id="${p.cid }" class="delete"> <img
		...
		$(".delete")
				.click(
						function() {
							if (confirm("确认删除?")) {
								var cid = this.id;
								window.location.href = "/WebProject/AdminCategoryServlet?method=delCategory&cid="
										+ cid;
							}
						});
	});
