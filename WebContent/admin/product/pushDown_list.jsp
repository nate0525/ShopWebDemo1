	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				...
				<tr>
					<td><c:if test="${not empty countDownProduct }">共${countDownProduct }个商品</c:if></td>
							...
							<c:forEach items="${page.list }" var="p">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${pageContext.request.contextPath}/AdminProductServlet?method=EditProductUI&backUri=dropdownlist&pid=${p.pid}&NowPage=${page.currentPageNum}">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="javascript:;" id=${p.pid } class="pushUp"> <img
											src="${pageContext.request.contextPath}/img/admin/i_edit.gif"
		...
		$(".pushUp")
				.click(
						function() {
							if (confirm("确定上架?")) {
								var id = this.id;
								window.location.href = "/WebProject/AdminProductServlet?method=PushUpProductByPid&nowPage="+ ${page.currentPageNum}+"&pid=" + id;
							}
						});
	});
	$(function() {
		$(".delete")
				.click(
						function() {
							if (confirm("确认删除?")) {
								var pid = this.id;
								window.location.href = "/WebProject/AdminProductServlet?method=delProduct&flag=1&nowPage="+ ${page.currentPageNum}+"&pid=" + pid;
							}
						});
	});
</script>
