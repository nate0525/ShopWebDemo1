...
<body>
	...
	<form id="orderForm" method="post"
		action="${pageContext.request.contextPath}/OrderServlet?method=payOrder&oid=${order.oid}">
		<div class="container">
			<div class="row">
				...
				<div style="margin-top: 5px; margin-left: 150px;">
					...
					<p>
						<br /> <input type="radio" name="pd_FrpId" value="ICBC-NET-B2C"
							...
							align="middle" />&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
							name="pd_FrpId" value="CMBCHINA-NET-B2C" checked="checked" />招商银行
						<img src="${pageContext.request.contextPath}/img/bank_img/cmb.bmp"
							align="middle" />
